...
public class BasePageObject {
    ...
    protected void waitForVisibilityOf(By locator, Integer... timeOutInSeconds) {
        ...
        while (attempts < 2) {
            try {
                ...
                log.info("StaleElementReferenceException: " + e);
            }
            attempts++;
        }
    }
    ...
    /** Perform scroll with custom value */
    public void scrollWithCustomValue(int pixels){
        log.info("Scrolling with custom value: " + pixels + "px");
